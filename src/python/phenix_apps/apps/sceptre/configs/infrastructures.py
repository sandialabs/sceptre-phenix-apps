...
class OPALRTInfrastructure(Infrastructure):
    ...
    def create_device(device_type, device_name, protocol, reg_config, **kwargs):
        ...
        if type(device_type) == str and device_type.lower() == "analog-read-write":
            device_kwargs = {
                "range": (-32767.0, 32767.0),
        ...
        if type(device_type) == str and device_type.lower() == "binary-read":
            device_kwargs = {
                "range": (0, 1000),
        ...
        if type(device_type) == str and device_type.lower() == "binary-read-write":
            device_kwargs = {
                "range": (0, 1000),
