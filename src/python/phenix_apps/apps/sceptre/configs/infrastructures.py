    ...
    def create_device(device_type, device_name, protocol, reg_config, **kwargs):
        if type(device_type) is str and device_type.lower() == "generator":
            ...
            device_kwargs = {
                ...
                "analog-read": kwargs.get(
                    "analog-read",
                    ["charging", "current", "source_mw", "target_mw", "phase_angle"],
                ),
                "binary-read": kwargs.get("binary-read", ["active"]),
                "binary-read-write": kwargs.get("binary-read-write", ["active"]),
            }
            ...
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get(
                    "analog-read-write", [1, 103, 120, 123]
                ),
            }
    ...
    def create_device(device_type, device_name, protocol, reg_config, **kwargs):
        if type(device_type) is str and device_type.lower() == "generator":
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get(
                    "analog-read-write", ["active_power_output", "power_factor"]
                ),
                "binary-read": kwargs.get("binary-read", ["active"]),
                "binary-read-write": kwargs.get("binary-read-write", ["active"]),
            }
            ...
            device_kwargs = {
                ...
                "analog-read": kwargs.get(
                    ...
                    [
                        ...
                        "real_power_src_p2",
                        "real_power_src_p3",
                        "reactive_power_src_p1",
                        "reactive_power_src_p2",
                        "reactive_power_src_p3",
                    ],
                ),
                "binary-read": kwargs.get("binary-read", ["active"]),
                "binary-read-write": kwargs.get("binary-read-write", ["active"]),
            ...
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get(
                    "analog-read-write", ["tap_setting_wdg1", "tap_setting_wdg2"]
                ),
                "binary-read": kwargs.get("binary-read", ["active"]),
                "binary-read-write": kwargs.get("binary-read-write", ["active"]),
            }
            ...
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get(
                    "analog-read-write", [1, 101, 123, 126]
                ),
                "binary-read": kwargs.get("binary-read", ["active"]),
                "binary-read-write": kwargs.get("binary-read-write", ["active"]),
            }
    ...
    def create_device(device_type, device_name, protocol, reg_config, **kwargs):
        if type(device_type) is str and device_type.lower() == "storagetank":
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get(
                    "analog-read-write", ["flow_in", "level_setpoint"]
                ),
                "binary-read": kwargs.get(
                    "binary-read",
                    ["fill_control", "empty_control", "emergency_shutoff"],
                ),
                "binary-read-write": kwargs.get(
            ...
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get(
                    "analog-read-write",
                    ["heating_rate", "level_setpoint", "temperature_setpoint"],
                ),
                "binary-read": kwargs.get(
                    "binary-read",
                    [
            ...
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get(
                    "analog-read-write",
                    ["mixing_rate", "level_setpoint", "mix_percent_setpoint"],
                ),
                "binary-read": kwargs.get(
                    "binary-read",
                    [
            ...
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get("analog-read-write", ["flow"]),
                "binary-read": kwargs.get("binary-read", ["active", "control"]),
                "binary-read-write": kwargs.get(
            ...
            device_kwargs = {
                ...
                "binary-read-write": kwargs.get("binary-read-write", ["open"]),
            }
    ...
    def create_device(device_type, device_name, protocol, reg_config, **kwargs):
        if type(device_type) is str and device_type.lower() == "storagetank":
            device_kwargs = {
                ...
                "analog-read": kwargs.get(
                    "analog-read",
                    ["level_setpoint", "flow_in", "tank_volume", "volume_to_drain"],
                ),
                "analog-read-write": kwargs.get(
                    "analog-read-write", ["flow_in", "level_setpoint"]
                ),
            ...
            device_kwargs = {
                ...
                "analog-read-write": kwargs.get(
                    "analog-read-write", ["flow", "voltage_in"]
                ),
                "binary-read": kwargs.get("binary-read", ["active", "control"]),
                "binary-read-write": kwargs.get(
                    "binary-read-write", ["active", "control"]
...
class OPALRTInfrastructure(Infrastructure):
    ...
    def create_device(device_type, device_name, protocol, reg_config, **kwargs):
        ...
        if type(device_type) is str and device_type.lower() == "analog-read-write":
            device_kwargs = {
                "range": (-32767.0, 32767.0),
        ...
        if type(device_type) is str and device_type.lower() == "binary-read":
            device_kwargs = {
                "range": (0, 1000),
        ...
        if type(device_type) is str and device_type.lower() == "binary-read-write":
            device_kwargs = {
                "range": (0, 1000),
...
class BatteryInfrastructure(Infrastructure):
    ...
    @staticmethod
    def create_device(device_type, device_name, protocol, reg_config, **_kwargs):
...
class Device(Infrastructure):
    def __init__(self, device_type, device_name, protocol, reg_config, **kwargs):
        ...
        super().add_analog_read_fields(device_type, kwargs.get("analog-read", []))
        super().add_analog_read_write_fields(
            device_type, kwargs.get("analog-read-write", [])
        )
        super().add_binary_read_fields(device_type, kwargs.get("binary-read", []))
        super().add_binary_read_write_fields(
            device_type, kwargs.get("binary-read-write", [])
        )
        self.registers = []
...
class Register:
    ...
    def __init__(
        self, devname, field, fieldtype, devtype, protocol, range_, reg_config
    ):
