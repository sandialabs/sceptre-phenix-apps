...
- **Ignition App**: Optional Perspective HMI (`perspective` metadata): generated project plus gateway-side tag auto-import of every point the connected devices actually serve, with the page auto-opened at logon on the gateway and on `type: perspective` hosts
